        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
          ...
          <div className="space-y-8">
            ...
            <ul className="space-y-4 text-sm text-gray-500">
              <li>
                <Link to="/menu" className="hover:text-white hover:pl-2 transition-all duration-300 block">
                  The Menu
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/our-story" className="hover:text-white hover:pl-2 transition-all duration-300 block">
                  Our Story
                </Link>
              </li>
              <li>
                <Link to="/contact" className="hover:text-white hover:pl-2 transition-all duration-300 block">
                  Contact Us
                </Link>
              </li>
            </ul>
