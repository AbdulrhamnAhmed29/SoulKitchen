    ...
    return (
        <div className="min-h-screen bg-[#050505] text-white pt-28 pb-20 px-4 md:px-10">
            ...
            <div className="max-w-7xl mx-auto mb-16 text-center">
                ...
                <div className="h-[1px] w-20 bg-gold-500 mx-auto bg-yellow-600"></div>
            </div>
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
                ...
                <div className="lg:col-span-4 order-2 lg:order-1 space-y-12">
                    <div className="bg-[#0a0a0a] border border-white/5 p-8 rounded-sm">
                        <h3 className="text-xl font-serif mb-6 text-yellow-600 uppercase tracking-wider">Opening Hours</h3>
