...
// 1. تعريف الـ Variants للكونتينر والأطفال خارج المكون لتحسين الأداء
const containerVariants = {
    hidden: { opacity: 0 },
    visible: {
        opacity: 1,
        transition: {
            staggerChildren: 0.1, // كل منتج يظهر بعد اللي قبله بـ 0.1 ثانية
            delayChildren: 0.3
        }
    }
};
    ...
    return (
        <section className="bg-black py-20 px-6 lg:px-12">
            <div className="max-w-[1400px] mx-auto">
                ...
                {/* Header - إضافة أنيميشن بسيط للعنوان */}
                <motion.div 
                ...
                >
                    <div className="text-center">
                        <h2 className="text-4xl capitalize md:text-5xl font-serif mb-4 text-white tracking-tight">
                            Our Offerings
                        </h2>
